...
devstrap sync   # shipped: pushes/pulls signed, envelope-encrypted events (--hub-file, hub: r2://<bucket>,
                # or hub: git+ssh://… — a private git repo as the zero-infra carrier),
