...
[ ] SSO
[ ] audit logs
[~] containerized agent sandbox (macOS Seatbelt + Linux bubblewrap + Landlock fallback + Linux seccomp denylist + unsigned local `sandbox.violation` telemetry shipped 2026-07-05, P4-GIT-03; tighter read confinement and containerization still open)
