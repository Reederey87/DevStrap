...
[ ] SSO
[ ] audit logs
[~] containerized agent sandbox (macOS Seatbelt + Linux bubblewrap + Landlock fallback + Linux seccomp denylist shipped 2026-07-05, P4-GIT-03; `sandbox.violation` telemetry, tighter read confinement, and containerization still open)
