...
1. ~~Ship a real `device.revoked` apply path~~ — SHIPPED (TRUST-01, 2026-07-05): revoked events are rejected by synced trust state fleet-wide, not only by the verifier that made the local revoke decision.
