...
**Status: wire format, hub snapshot plane, and snapshot import + `ErrSnapshotRequired` recovery shipped; the `hub compact` producer and tombstone GC land as the following PRs of the same wave.**
