...
**Status: wire format + hub snapshot plane shipped; import/recovery (`sync`), the `hub compact` producer, and tombstone GC land as the following PRs of the same wave.**
