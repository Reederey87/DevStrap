...
- OS sandboxing is required before public release — macOS Seatbelt, Linux bubblewrap, and Linux Landlock fallback shipped 2026-07-05 (`P4-GIT-03`, default-on via `--sandbox auto`); remaining slices are seccomp, `sandbox.violation` telemetry, and tighter read confinement.
