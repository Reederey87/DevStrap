...
- OS sandboxing is required before public release — macOS Seatbelt, Linux bubblewrap, Linux Landlock fallback, and the Linux seccomp syscall denylist shipped 2026-07-05 (`P4-GIT-03`, default-on via `--sandbox auto`); remaining slices are `sandbox.violation` telemetry and tighter read confinement.
