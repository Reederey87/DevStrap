...
Follow-ups:
- Remaining Phase A: SEC-01 (hub-side revoke delete via `DeleteBlob`), SEC-04 (fail-closed bootstrap), SEC-02 (encrypt namespace map), SEC-05 (sign releases). Then Phases B–E.
