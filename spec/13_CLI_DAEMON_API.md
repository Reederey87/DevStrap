...
- `status` prints schema version (currently **25** after `00025_blob_ref_indexes.sql` added the `NOCASE` blob-reference indexes for the revoke/rewrap scans, `P7-DATA-06`), SQLite `quick_check`, and SQLite `foreign_key_check`;
