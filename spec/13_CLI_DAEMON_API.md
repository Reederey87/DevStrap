...
- `status` prints schema version (currently **29** after `00029_device_gitstate.sql` added the working-state validation plane Layer A mirror table, `P7-GITSTATE-01`; see `12_DATA_MODEL_SQLITE.md`), SQLite `quick_check`, and SQLite `foreign_key_check`;
